...
// MakePaymentInterfaceMock is an autogenerated mock type for the MakePaymentInterfaceMock type
type MakePaymentInterfaceMock struct {
	mock.Mock
}
...
// NewMakePaymentInterface creates a new instance of MakePaymentInterfaceMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMakePaymentInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *MakePaymentInterfaceMock {
	mock := &MakePaymentInterfaceMock{}
	mock.Mock.Test(t)
